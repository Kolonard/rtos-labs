...
В своём репозитории нажмите "<> Code" и скопируйте ссылку.
![<> Code](images/image_4.png)

Введите в терминал приложения в котором вы работаете git clone <скопированная сыылка> Пример:
![Пример:](images/image_5.png)

Перейдите в директорию проекта: cd <имя_репозитория>.
